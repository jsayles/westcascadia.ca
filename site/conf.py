...
BLOG_AUTHOR = "Jacob Sayles"  # (translatable)
BLOG_TITLE = "West Cascadia"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://westcascadia.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://westcascadia.ca/"
BLOG_EMAIL = "jacob@westcascadia.ca"
BLOG_DESCRIPTION = "A movement to form a new Canadian Province named West Cascadia"  # (translatable)
